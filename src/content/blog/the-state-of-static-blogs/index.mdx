...
<InfoBox type="inform">
**Informational**: Discrete math, graph theory, and combinatorial optimization ahead! If you're unfamiliar with the mathematical symbols used in this writeup, reference this dropdown:
</InfoBox>

<div class="mx-auto my-auto flex flex-col gap-y-8 rounded-xl border p-4">
<details>
  <summary class="cursor-pointer mb-4"><b>[v1.0] Complicated Math Symbols</b></summary>
